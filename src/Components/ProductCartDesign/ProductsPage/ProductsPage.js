              ...
              state.data?.map((item) => (
                <div className="col">
                  <div className="card h-100">
                    ...
                    <div className="">
                      <div className="text-black d-flex justify-content-between mx-2" >
                        <div className="fw-bold">Price: {item.price}</div>
                        <div className="fw-bold"> Stock :{item.stock}</div>
                      </div>
                    </div>
                    <div>
                    ...
                    <div>
                      <div className="text-danger ">
                        <button
                          className="border-0 w-100 hovereffect py-2 fw-bold"
                          onClick={() => {
                            dispatch({
